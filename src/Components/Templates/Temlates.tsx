                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="word-wrap:break-word;font-size:0px;padding:0px 20px 0px 20px;" align="left">
                        ...
                        font-family:Ubuntu, Helvetica, Arial, sans-serif;
                        font-size:11px;line-height:22px;text-align:left;">
                        <% options[3].elements.forEach(function(product) { %>
                          ...
                          cellspacing="0" height="81" id="template__products"
                            ...
                            <tbody>
                              <tr>
                                <td>
                                <img src='<%=product.elements[5].value%>' alt='product img' style='width:100px'></td>
                                <td>
                                  <table align="left" 
                                  border="0" cellpadding="1" cellspacing="5" height="77" width="263">
                                    <tbody>
                                      <tr>
                                        <td>
                                          <span style="font-size:18px;"><%=product.elements[1].value%></span>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <span style="color:#999999;">
                                            <span style="font-size: 14px;"><%=product.elements[2].value%></span>
                                          </span>
                                        </td>
                                      </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td rowspan="2">
                                          ...
                                          <%=product.elements[3].value%> X <%=product.elements[4].value%></span>
                                        </td>
                                      </tr>
                                      <tr> </tr>
                                    </tbody>
                              ...
                              <td style="word-wrap:break-word;font-size:0px;padding:0px 20px 0px 20px;" align="left">
                                ...
                                font-size:11px;line-height:22px;text-align:left;">
                                  <table border="0" cellpadding="1" cellspacing="1" style="width: 300px;">
                                    <tbody>
                                      <tr>
                                        <td><%=options[4].elements[0].value%></td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <table border="0" cellpadding="1" cellspacing="1" height="65" width="292">
                                            <tbody>
                                              <tr>
                                                <td><%=options[4].elements[1].value%></td>
                                                <td>
                                                  <span style="font-size:14px;">8 800 775 85 25</span>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td><%=options[4].elements[2].value%></td>
                                                <td>
